...
export interface BrandEngagementOverviewProps {}

const BrandEngagementOverview: React.SFC<BrandEngagementOverviewProps> = () => {
...
export default BrandEngagementOverview;
